...
const ai = new GoogleGenAI({
  apiKey: "AIzaSyC50KlxRJqSPl0jhSzVlFNp9-a9P8rPKEU",
});
...
app.post("/addPatient", async (req, res) => {
  try {
    ...
    const prompt =
      "Extract ICD codes from the following text and put comma between them and remove the point symbol (.) in each code if it exists :\n" +
      body.icdCodes;
